...
import FormReturn from './form.return/form.return';
import FormOneWay from './form.oneway/form.one.way';
...
const FormCheckInReturnAndOneWay = () => {
  ...
  return(
    <>     
      <form className='form br4 pa2 ma4 dib shadow-2'>
        ...
        {value=== 'return' && <Link to={url2}><button disabled={!from || !to || !departure || !retur || !cabine } className='search-flights grow br4'>Search Flights</button></Link>}
...
export default FormCheckInReturnAndOneWay;
